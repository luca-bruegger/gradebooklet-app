...
export class PdfController {
    ...
    createRows(module: Module) {
        const rows = [];

        rows.push([{text: module.name, fontSize: 14, bold: true, margin: [20, 20, 0, 8]}, {}, {}],
            [{text: module.teacher, style: 'tableHeader', alignment: 'center', margin: [0, 5, 0, 10]},
                {text: module.building, style: 'tableHeader', alignment: 'center', margin: [0, 5, 0, 10]},
                {text: module.room, style: 'tableHeader', alignment: 'center', margin: [0, 5, 0, 10]}],
            [{text: this.translate.instant('module.name'), style: 'tableHeader', alignment: 'center'},
        ...
        rows.push([{}, {
            ...
            alignment: 'center',
            margin: [0, 5, 0, 10]
        }, {text: module.average, alignment: 'center', bold: true, margin: [0, 5, 0, 10]}]);
